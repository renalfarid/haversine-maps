...
<template>
   <div class="mt-10 flex items-center rounded-md shadow-md">
    <!-- Proportional width container -->
    <div class="max-w-screen-md w-full flex mb-4">
      <!-- Form Section -->
      <div class="max-w-screen-sm p-6 bg-white rounded-md">
        ...
        <form @submit.prevent="handleSubmit">
            <div class="mb-4">
                ...
                <input type="text" id="studentName" v-model="studentName" placeholder="Enter student name"
            ...
            <div class="mb-4">
                ...
                <textarea id="studentAddress" v-model="studentAddress"
                 placeholder="Enter student address"
                 class="mt-1 p-2 border rounded-md w-full h-36"
                ></textarea>
            </div>
        
            <button type="submit" class="bg-blue-500 text-white p-2 rounded-md hover:bg-blue-600 transition duration-300">
                Cari Sekolah
            </button>
            </form>
      </div>
      ...
      <div class="p-6 bg-white rounded-md">
        ...
        <div v-if="listNearestSchool.length > 0">
                <div v-for="school in listNearestSchool" :key="school.npsn" class="p-3 mb-4 p-4 border rounded-md">
    ...
    <!-- Maps Section -->
    <div class="max-w-screen-lg w-full p-6 bg-white rounded-md">
